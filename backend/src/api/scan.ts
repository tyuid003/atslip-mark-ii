        ...
        try {
          ...
          const broadcastPayload = {
            ...
            data: {
              ...
              tenant_name: matchedTenant.name || null,
              slip_ref: slip.transRef || null,
              amount: slip.amount.amount,
              sender_name: senderNameTh || senderNameEn || 'Unknown',
              sender_account: senderAccount || null,
              receiver_name: receiverNameTh || receiverNameEn || null,
              receiver_account: receiverAccount || null,
              slip_date: slip.date || null,
              matched_user_id: matchedUser?.memberCode || matchedUser?.username || null,
              ...
              scanned_by_photo: scannedByPhoto || null,
              created_at: now,
            },
          };
